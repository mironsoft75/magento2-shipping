...
namespace Salecto\Shipping\Block\Adminhtml\Rate\Edit;
...
use Salecto\Shipping\Model\Provider\CurrentRate;
use Salecto\Shipping\Model\Rate;
use Salecto\Shipping\Model\RateRepository;
...
class Conditions extends Generic implements TabInterface
{
     ...
     * @throws LocalizedException
     */
    protected function addTabToForm($rate, $fieldsetId = 'conditions_fieldset', $formName = 'salecto_shipping_rate_form')
    {
        if (!$rate) {
        ...
        $newChildUrl = $this->getUrl(
            'salecto_shipping/rate/newConditionHtml/form/' . $conditionsFieldSetId,
