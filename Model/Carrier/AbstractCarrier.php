...
namespace Salecto\Shipping\Model\Carrier;
...
use Salecto\Reepay\Api\Reepay\MethodInterface;
...
/**
 * @package Salecto\Shipping\Model\Carrier
 */
abstract class AbstractCarrier extends \Magento\Shipping\Model\Carrier\AbstractCarrier implements CarrierInterface, ShippingCarrierInterface
{
    /**
     * @var bool
     */
    ...
    public function convertAdditionalRateData(ShippingMethodInterface $shippingMethod, Rate $rate)
    {
        ...
        $shippingMethod->getExtensionAttributes()->setSalectoShippingMethodType($methodType);
        ...
        if ($methodTypeHandler && isset($methodTypeHandler['type'])
            ...
            $shippingMethod->getExtensionAttributes()->setSalectoShippingMethodTypeHandler(
                $typeCode
            );
        }
        $shippingMethod->getExtensionAttributes()->setSalectoShippingMethodImage(
            $this->getImageUrl($shippingMethod, $rate, $typeCode ?? null) ?: ''
        );

        $shippingMethod->getExtensionAttributes()->setSalectoShippingMethodSortOrder(
