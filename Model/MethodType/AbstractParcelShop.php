...
namespace Salecto\Shipping\Model\MethodType;
...
/**
 * @package Salecto\Shipping\Model\MethodType
 */
abstract class AbstractParcelShop
{
    ...
    {
        $shippingData = $this->jsonSerializer->unserialize($order->getData('salecto_shipping_data'));
