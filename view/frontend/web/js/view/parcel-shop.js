    ...
    return Component.extend({
        defaults: {
            ...
            links: {
                ...
                postcode: '${ $.provider }:salectoShippingData.postcode',
                firstname: '${ $.provider }:salectoShippingData.name',
                lastname: '${ $.provider }:salectoShippingData.lastname',
                phone: '${ $.provider }:salectoShippingData.phone',
        ...
        initialize: function() {
            ...
            this.isChosenShippingMethod = ko.pureComputed(function() {
                ...
                return (this.shippingMethod().carrier_code + '-' +
                    this.shippingMethod().extension_attributes.salecto_shipping_method_type_handler) === this.index;
            }, this);
        ...
        initObservable: function() {
            return this._super()
                ...
                .observe('firstname lastname phone shippingFirstname shippingLastname shippingPhone salectoShippingData')
        ...
        search: function() {
            ...
            this.parcelShopSearcher(this.source.get('salectoShippingData'), this.shippingCountryId(), this)
